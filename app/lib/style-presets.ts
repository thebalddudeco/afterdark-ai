...
export const STYLE_PRESETS: StylePreset[] = [
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "innie pussy adjuster", file: "Moody_Innie_Adjuster.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "breast size slider", file: "Moody_Breast_Size_Slider.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "midjourney artful nsfw", hiddenPrompt: "artful editorial composition, premium cinematic lighting", file: "Moody_Artful_NSFW.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "female body retouched", hiddenPrompt: "retouched skin, polished body detail, refined anatomy", file: "Moody_Body_Retouch.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "60s psychedelic movie", hiddenPrompt: "1960s psychedelic movie still, retro color palette, surreal film grain", file: "Moody_60s_Psychedelic.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "areola size slider", file: "Moody_Areola_Size_Slider.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "skin tone slider", file: "Moody_Skin_Tone_Slider.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "ropebondage", hiddenPrompt: "consensual rope bondage styling, rope harness fashion", file: "Moody_Rope_Bondage_v2.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "egypt queen fiction", hiddenPrompt: "ancient egyptian queen styling, ornate gold jewelry, cinematic fantasy portrait", file: "Moody_Egypt_Queen.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "chaincollar", hiddenPrompt: "chain collar accessory, metallic collar detail", file: "Moody_Chain_Collar.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "nostalgic cinema", hiddenPrompt: "nostalgic cinema still, vintage film look, soft cinematic grading", file: "Moody_Nostalgic_Cinema.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "non-mainstream fashiongenerator", hiddenPrompt: "avant-garde non-mainstream fashion editorial", file: "Moody_Fashion_Generator.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "crowdstreet", hiddenPrompt: "busy street crowd background, candid urban photography", file: "Moody_Crowd_Street.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Real", trigger: "chun-li", file: "Moody_Chun_Li_v2.safetensors", strength: 1,
