...
export const BASE_MODELS: BaseModelPreset[] = [
  ...
  { id: "moody-pro", name: "Moody Pro Mix", modes: ["txt-img", "img-img"], ready: false },
...
export const STYLE_PRESETS: StylePreset[] = [
  ...
  },
  {
    ...
    engine: "RedCraft", trigger: "skin tone slider", file: "RedCraft_Skin_Tone_Slider.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "RedCraft", trigger: "mons pubis slider", file: "RedCraft_Mons_Pubis_Slider.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "RedCraft", trigger: "purple grainy photography", hiddenPrompt: "grainy film photography, purple color grade, editorial flash photography", file: "RedCraft_Purple_Grain.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "RedCraft", trigger: "pornmaster asian slider", file: "RedCraft_Pornmaster_Asian.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "RedCraft", trigger: "purple graphics poster", hiddenPrompt: "graphic poster composition, bold purple print design, stylized editorial layout", file: "RedCraft_Purple_Poster.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "RedCraft", trigger: "transparent clothes", hiddenPrompt: "see-through fabric, sheer clothing, transparent fabric texture", file: "RedCraft_Transparent_Clothes.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "RedCraft", trigger: "idontknowhowtonamethisartstyle", file: "RedCraft_Weird_Art.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "RedCraft", trigger: "breast size slider", file: "RedCraft_Breast_Size_Slider.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "RedCraft", trigger: "better pussy", file: "RedCraft_Better_Pussy.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "RedCraft", trigger: "turbo asianmix", file: "RedCraft_AsianMix_Turbo.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "LTX 2.3", trigger: "swing up and down legs", hiddenPrompt: "legs swinging up and down motion", file: "LTX23_Leg_Swing_Up_Down.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "LTX 2.3", trigger: "swing in and out legs", hiddenPrompt: "legs swinging in and out motion", file: "LTX23_Leg_Swing_In_Out.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "LTX 2.3", trigger: "east asian facial fidelity", hiddenPrompt: "preserve facial identity, consistent facial features", file: "LTX23_East_Asian_Face_Fidelity.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "LTX 2.3", trigger: "mila", file: "LTX23_Mila.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "LTX 2.3", trigger: "bonnie rabbit", file: "LTX23_Bonnie_Rabbit.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "innie pussy adjuster", file: "Moody_Innie_Adjuster.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "breast size slider", file: "Moody_Breast_Size_Slider.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "midjourney artful nsfw", hiddenPrompt: "artful editorial composition, premium cinematic lighting", file: "Moody_Artful_NSFW.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "female body retouched", hiddenPrompt: "retouched skin, polished body detail, refined anatomy", file: "Moody_Body_Retouch.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "60s psychedelic movie", hiddenPrompt: "1960s psychedelic movie still, retro color palette, surreal film grain", file: "Moody_60s_Psychedelic.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "areola size slider", file: "Moody_Areola_Size_Slider.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "skin tone slider", file: "Moody_Skin_Tone_Slider.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "ropebondage", hiddenPrompt: "consensual rope bondage styling, rope harness fashion", file: "Moody_Rope_Bondage_v2.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "egypt queen fiction", hiddenPrompt: "ancient egyptian queen styling, ornate gold jewelry, cinematic fantasy portrait", file: "Moody_Egypt_Queen.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "chaincollar", hiddenPrompt: "chain collar accessory, metallic collar detail", file: "Moody_Chain_Collar.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "nostalgic cinema", hiddenPrompt: "nostalgic cinema still, vintage film look, soft cinematic grading", file: "Moody_Nostalgic_Cinema.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "non-mainstream fashiongenerator", hiddenPrompt: "avant-garde non-mainstream fashion editorial", file: "Moody_Fashion_Generator.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "crowdstreet", hiddenPrompt: "busy street crowd background, candid urban photography", file: "Moody_Crowd_Street.safetensors", strength: 1,
  ...
  },
  {
    ...
    engine: "Moody Pro", trigger: "chun-li", file: "Moody_Chun_Li_v2.safetensors", strength: 1,
